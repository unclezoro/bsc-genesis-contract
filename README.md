...
This repo hold all the genesis contracts on Binance Smart chain. More details in [doc-site](https://docs.binance.org/smart-chain/guides/concepts/system-contract.html).
